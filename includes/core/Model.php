...
class MXSL_Model
{
	...
	* Table name
	*/
	protected $table = MXSL_TABLE_SLUG;
	...
	*/
	public function mxsl_get_row( $table = NULL, $wher_name, $wher_value )
	{
	...
	*/
	public function mxsl_get_results( $table = false, $wher_name = NULL, $wher_value = 1 )
	{
