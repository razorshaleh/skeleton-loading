...
// create table class
require_once MXSL_PLUGIN_ABS_PATH . 'includes/core/create-table.php';

class MXSL_Basis_Plugin_Class
{

	private static $table_slug = MXSL_TABLE_SLUG;
	...
	public static function activate()
	{
		...
		$product_table = new MXSLCreateTable( $table_name );
...
tempor incididunt ut labore et dolore magna aliqua.'
	...
	*/
	public static function create_option_for_activation()
	{
		...
		add_option( 'mxsl_flush_rewrite_rules', 'go_flush_rewrite_rules' );
